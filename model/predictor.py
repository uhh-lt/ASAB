...
METHODS = {
    ...
    'buniform': {
        'class': "DummyClassifierUniformSentiment",
        'model': None
    },
    'bstratified': {
        'class': "DummyClassifierStratifiedSentiment",
        'model': None
    },
    'bmost': {
        'class': "DummyClassifierMostSentiment",
        'model': None
    },
    'randomf': {
        'class': "RandomForestClassifierSentiment",
        'model': None
    },
    'knn': {
        'class': "KNeighborsTransformerSentiment",
        'model': None
    },
    'NearestCentroid': {
        'class': "NearestCentroidSentiment",
        'model': None
    },
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dir', type=str, help="Train/dev/test data file (str)", default=DIR)
    ...
    print(args.dir)
    files = (args.dir+"/"+args.train, args.dir+"/"+args.dev, args.dir+"/"+args.test)   # Paths to train, dev and test files (str)
