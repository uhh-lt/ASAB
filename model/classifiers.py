...
class Base:
    ...
    def accuracy(self, df: pd.DataFrame) -> None:
        ...
        recall = recall_score(df['truth'], df['pred'], average='macro')*100
        precision = precision_score(df['truth'], df['pred'], average='macro')*100
...
class DummyClassifierMostSentiment(Base):
    """Predict sentiment scores using Logistic Regression.
    Uses a sklearn pipeline.
    """
    def __init__(self, model_file: str=None) -> None:
...
class DummyClassifierStratifiedSentiment(Base):
    """Predict sentiment scores using Logistic Regression.
    Uses a sklearn pipeline.
    """
    def __init__(self, model_file: str=None) -> None:
...
class DummyClassifierUniformSentiment(Base):
    """Predict sentiment scores using Logistic Regression.
    Uses a sklearn pipeline.
    """
    def __init__(self, model_file: str=None) -> None:
...
class NearestCentroidSentiment(Base):
    """Predict sentiment scores using Logistic Regression.
    Uses a sklearn pipeline.
    """
    def __init__(self, model_file: str=None) -> None:
...
class KNeighborsTransformerSentiment(Base):
    """Predict sentiment scores using Logistic Regression.
    Uses a sklearn pipeline.
    """
    def __init__(self, model_file: str=None) -> None:
...
class RandomForestClassifierSentiment(Base):
    """Predict sentiment scores using Logistic Regression.
    Uses a sklearn pipeline.
    """
    def __init__(self, model_file: str=None) -> None:
